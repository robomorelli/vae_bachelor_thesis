...
%This is required to make the validation subset corresponding to the full 139 fb$^{-1}$ Run-2 \sqsthirt\  = 13 \TeV\ $pp$ collision data set~\cite{HiggsChalllenge}.
